...
const Post = () => {
    return (
        <div className="post row">
            <div className="card large col s12 m5 offset-m3">
            ...
            <div className="card large col s12 m5 offset-m3">
                ...
                <div className="card-reveal">
                    <span className="card-title grey-text text-darken-4">First Memory</span>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A quas repudiandae tempore molestiae tempora, perferendis quo, quis vel sunt, assumenda qui nam? Eaque quae quis vel corporis accusantium quas cupiditate?</p>
                </div>
            </div>
            <div className="card large col s12 m5 offset-m3">
                <div className="card-image waves-effect waves-block">
